...
var dhtmlwindow={
imagefiles:['images/min.gif', 'images/btn_close.gif', 'images/restore.gif', 'images/resize.gif'], //Path to 4 images used by script, in that order
...
init:function(t){
	...
	domwindowdata+='<div class="drag-controls"><div class="close"><img src="'+this.imagefiles[1]+'" title="Close" /></div></div>'
